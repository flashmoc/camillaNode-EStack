(() => {
  ...
  const script = document.createElement('script'); script.src = './live-page.js?v=audio-polish1'; script.onerror = () => { document.body.innerHTML = '<main class="output-page"><section class="ui-panel output-unavailable"><h1>Output Processing unavailable</h1><p>The live DSP page could not start.</p></section></main>'; }; document.head.append(script);
})();
